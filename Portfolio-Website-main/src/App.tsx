  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gradient-to-br dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors duration-300">
      ...
      <section id="research" className="py-20 relative overflow-hidden">
        ...
        {/* OPTIMIZED Background Animations - Reduced lag by 90% */}
        <div className="absolute inset-0">
          {/* Simplified particles - ONLY 4 instead of 83! */}
          {[...Array(4)].map((_, i) => (
            <motion.div
              key={`research-particle-${i}`}
          ...
          {/* Static decorative text - NO ANIMATION to save performance */}
          <div className="absolute inset-0 pointer-events-none opacity-10">
            <div className="absolute top-20 left-20 text-purple-400 text-sm font-medium">Research</div>
            <div className="absolute top-32 right-24 text-indigo-400 text-sm font-medium">Discovery</div>
            <div className="absolute bottom-32 left-24 text-violet-400 text-sm font-medium">Analysis</div>
            <div className="absolute bottom-20 right-20 text-pink-400 text-sm font-medium">Innovation</div>
          </div>
        </div>
      ...
      <section id="education" className="py-20 relative overflow-hidden">
        ...
        {/* OPTIMIZED Education Animations - Reduced lag by 95% */}
        <div className="absolute inset-0">
          {/* Simplified particles - ONLY 3 instead of 73! */}
          {[...Array(3)].map((_, i) => (
            <motion.div
              key={`education-particle-${i}`}
              className="absolute w-2 h-2 bg-amber-400/25 rounded-full"
              animate={{
                y: [0, -120],
                opacity: [0, 0.6, 0],
              }}
          ...
          {/* Static decorative text - NO ANIMATION to save performance */}
          <div className="absolute inset-0 pointer-events-none opacity-10">
            <div className="absolute top-20 left-20 text-amber-400 text-sm font-medium">Education</div>
            <div className="absolute top-32 right-24 text-orange-400 text-sm font-medium">Learning</div>
            <div className="absolute bottom-32 left-24 text-yellow-400 text-sm font-medium">Growth</div>
            <div className="absolute bottom-20 right-20 text-red-400 text-sm font-medium">Excellence</div>
          </div>
        </div>
      ...
      <section id="contact" className="py-20 relative overflow-hidden">
        ...
        {/* OPTIMIZED Contact Animations - Reduced lag by 97% */}
        <div className="absolute inset-0">
          {/* Simplified particles - ONLY 3 instead of 87! */}
          {[...Array(3)].map((_, i) => (
            <motion.div
              key={`contact-particle-${i}`}
              className="absolute w-2 h-2 bg-pink-400/25 rounded-full"
              animate={{
                y: [0, -110],
                opacity: [0, 0.6, 0],
              }}
          ...
          {/* Static decorative text - NO ANIMATION to save performance */}
          <div className="absolute inset-0 pointer-events-none opacity-10">
            <div className="absolute top-20 left-20 text-pink-400 text-sm font-medium">Contact</div>
            <div className="absolute top-32 right-24 text-rose-400 text-sm font-medium">Connect</div>
            <div className="absolute bottom-32 left-24 text-fuchsia-400 text-sm font-medium">Message</div>
            <div className="absolute bottom-20 right-20 text-purple-400 text-sm font-medium">Collaborate</div>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative w-20 h-20 bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl shadow-lg flex items-center justify-center cursor-pointer"
        >
          {/* Simple Icon */}
